...
This is the main orchestrator.  It uses:
  - flutter_dash package for theme, components, data utilities
  - dashboards/analytics/ for this dashboard's config and sections

To create a new dashboard, copy dashboards/analytics/ and change config.py.
"""
...
from dashboards.analytics.config import (
    PAGE_TITLE, PAGE_ICON, DASHBOARD_HEADING,
    DATE_COL, DIMENSIONS, CHART_METRIC_OPTIONS,
)
from dashboards.analytics.data_loader import load_data
...
# ── Theme ─────────────────────────────────────────────────────────────────────
apply_theme(st, FLUTTER_DARK, page_title=PAGE_TITLE, page_icon=PAGE_ICON)
...
sidebar.add_header(PAGE_TITLE, "Performance Dashboard")
